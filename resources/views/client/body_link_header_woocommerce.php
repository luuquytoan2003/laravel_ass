...
<html lang="en-US" itemscope="itemscope" itemtype="http://schema.org/WebPage">
    ...
    <body class="page home page-template-default woocommerce-checkout woocommerce-page woocommerce-order-received can-uppercase woocommerce-wishlist woocommerce-active single-product full-width extended can-uppercase">
