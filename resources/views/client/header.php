                    ...
                    <div class="techmarket-sticky-wrap">
                        <div class="row">
                            <div class="site-branding">
                                <a href="index.php?action=home" class="custom-logo-link" rel="home">
                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    <li class="sale-clr yamm-fw menu-item animate-dropdown">
                                        <a title="Super deals" href="index.php?action=shop">Sản Phẩm</a>
                                    </li>
                                                    ...
                                                    <div class="tm-mega-menu">
                                                        ...
                                                        <div class="widget widget_nav_menu">
                                                            <ul class="menu">
                                                                ...
                                                                <li class="menu-item">
                                                                    <a href="?action=login_and_register">My Account</a>
                                                                </li>
                                                                <li class="menu-item">
                            ...
                            <nav id="secondary-navigation" class="secondary-navigation" aria-label="Secondary Navigation" data-nav="flex-menu">
                                <ul id="menu-secondary-menu" class="nav">
                                    ...
                                    <li class="menu-item">
                                        <a title="My Account" href="?action=login_and_register">
                                            
                                            <i class="tm tm-login-register"></i><?php 
                                            if (isset($_SESSION['username'])) {
                                                echo $_SESSION['username'];
                                            }else{
                                                echo 'Register or Sign in';
                                            }
                    ...
                    <div class="handheld-header">
                        <div class="row">
                            ...
                            <div class="handheld-header-links">
                                <ul class="columns-3">
                                    <li class="my-account">
                                        <a href="?action=login_and_register" class="has-icon">
