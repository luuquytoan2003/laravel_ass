                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="tp-product-item-2">
                                            <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                <a href="product-details.html">
                                                    <img src="client/assets/img/product/trending/trending-1.jpg"
                                                        alt="">
                                                </a>
                                                <!-- product action -->
                                    ...
                                    <div class="tp-trending-item swiper-slide">
                                        <div class="tp-product-item-2">
                                            <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                <a href="product-details.html">
                                                    <img src="client/assets/img/product/trending/trending-2.jpg"
                                                        alt="">
                                                </a>
                                                <!-- product action -->
                                                <div class="tp-product-action-2 tp-product-action-blackStyle">
                                    ...
                                    <div class="tp-trending-item swiper-slide">
                                        <div class="tp-product-item-2">
                                            <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                <a href="product-details.html">
                                                    <img src="client/assets/img/product/trending/trending-3.jpg"
                                                        alt="">
                                                </a>
                                                <!-- product action -->
                                                <div class="tp-product-action-2 tp-product-action-blackStyle">
                ...
                <div class="col-xl-4 col-lg-5 col-md-8 col-sm-10">
                    <div class="tp-trending-banner p-relative ml-35">
                        <div class="tp-trending-banner-thumb w-img include-bg"
                            data-background="client/assets/img/product/trending/banner/trending-banner.jpg"></div>
