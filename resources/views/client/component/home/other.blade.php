                        ...
                        <div class="tab-content m-img" id="productDetailsNavContent">
                            <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                ...
                                <div class="tp-product-details-nav-main-thumb">
                                    <img src="assets/img/product/details/3/main/product-details-main-1.jpg"
                                        alt="">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-2" role="tabpanel"
                                ...
                                <div class="tp-product-details-nav-main-thumb">
                                    <img src="assets/img/product/details/3/main/product-details-main-2.jpg"
                                        alt="">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-3" role="tabpanel"
                                ...
                                <div class="tp-product-details-nav-main-thumb">
                                    <img src="assets/img/product/details/3/main/product-details-main-3.jpg"
                                        alt="">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-4" role="tabpanel"
                                ...
                                <div class="tp-product-details-nav-main-thumb">
                                    <img src="assets/img/product/details/3/main/product-details-main-4.jpg"
                                        alt="">
                                </div>
                            </div>
                        </div>
