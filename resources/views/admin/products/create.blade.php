                ...
                <div class="card-body p-2">
                    <div class="form-group m-0">
                        ...
                        <textarea name="short_description" id="ckeditor" cols="30" rows="10" class="form-control"
                            placeholder="Nhập mô tả ngắn của sản phẩm "></textarea>
                    </div>
                </div>
            </div>
            {{-- variant-price  --}}
                                    ...
                                    <tr>
                                        <td  class="text-center">
                                            @foreach ($item as $key => $i)
                                                <label for=""> {{$key > 0 ? ' | ' : ''}} {{ $i->value }} </label>
                                            @endforeach
                                        </td>
                                        <td><input name="price[]" type="text" class="form-control form-control-sm">
                                        </td>
                                        <td><input name="stock[]" type="text" class="form-control form-control-sm">
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="card mt-2">
                <div class="card-body p-2">
                    <div class="form-group m-0">
                        ...
                        <div id="image-preview-container" class="mb-1 row"></div>
