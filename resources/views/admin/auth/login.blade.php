              ...
              <div class="auth-form-light text-left p-5">
                ...
                @csrf
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Username" name="email" value="{{ old('email') }}">
                    @if ($errors->has('email'))
                  ...
                  <div class="form-group">
                    ...
                    @if ($errors->has('password'))
                        <span style="font-size: 13px" class="text-danger"> {{ $errors->first('password') }} </span>
                    @endif
                  </div>
                  <div class="mt-3">
